...
def print_header():
    ...
    header_red = r"""
      ...
      |___/ /_/ \_\  _|\_\ \___/    \___| \___//___|
        """
    header_white = r"""
    Welcome to the wild side! Here’s to getting banned—may it be legendary!
Just know, I’m sending good vibes and coffee your way!"""

    print(Fore.YELLOW + header_orange.strip(), end='')
    print(Fore.RED + header_red, end='')
